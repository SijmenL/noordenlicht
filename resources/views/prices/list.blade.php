                        ...
                        <div class="-body p-0">
                            <div class="table-responsive">
                                <table class="table table-hover align-middle mb-0">
                                    ...
                                    <tr>
                                        <th class="ps-4 py-3 text-secondary">Naam</th>
                                        <th class="py-3 text-secondary">Type</th>
                                        <th class="pe-4 py-3 text-end text-secondary" style="min-width: 250px;">Tarief</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    @forelse($accommodaties as $acco)
                                        @php
                                        ...
                                        @endphp
                                        <tr>
                                            <td class="ps-4 fw-bold text-dark">{{ $acco->name }}</td>
                                            <td class="text-muted">{{ $acco->type }}</td>
                                            <td class="pe-4 text-end">
                                                {{-- Discount Badge --}}
                                                @if($hasDiscount)
                                                    <div class="mb-1">
                                                        <span class="badge bg-success fw-bold rounded-pill">@if($totalPercentageDiscounts > 0)
                                ...
                                korting!</span>
                                                ...
                                                <div>
                                                    ...
                                                    <span class="text-muted small fw-normal ms-1">p/u</span>
                                                </div>
                                                ...
                                                @if($percentageAdditions->isNotEmpty())
                                                    <div class="text-muted small" style="font-size: 0.75rem;">
                                                        ...
                                                        @foreach($percentageAdditions as $cost)
                                                            {{ $cost->name }} {{ $cost->amount }}% - € {{ number_format($totalBasePrice * ($cost->amount / 100), 2, ',', '.') }}
                                                            @if(!$loop->last), @endif
                                                        @endforeach
                                                        )
                                                    </div>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="3" class="text-center py-4 text-muted">Geen accommodaties gevonden.</td>
                                        </tr>
                                    @endforelse
                                    </tbody>
                                </table>
                        ...
                        <div class="-body p-0">
                            <div class="table-responsive">
                                <table class="table table-hover align-middle mb-0">
                                    <thead class="bg-light">
                                    <tr>
                                        <th class="ps-4 py-3 text-secondary">Activiteit</th>
                                        <th class="py-3 text-secondary">Locatie</th>
                                        <th class="pe-4 py-3 text-end text-secondary" style="min-width: 250px;">Prijs</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    @forelse($activities as $activity)
                                        ...
                                        @endphp
                                        <tr>
                                            <td class="ps-4 fw-bold text-dark">{{ $activity->title }}</td>
                                            <td class="text-muted">{{ $activity->location ?? 'NoordenLicht' }}</td>
                                            <td class="pe-4 text-end">
                                ...
                                korting!</span>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="3" class="text-center py-4 text-muted">Geen activiteiten gevonden.</td>
                                        </tr>
                                    @endforelse
                                    </tbody>
                                </table>
