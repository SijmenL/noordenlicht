                    ...
                    <div class="col-lg-7 order-lg-1">
                        <div class="pe-lg-5">
                            ...
                            <form method="POST" action="{{ route('contact.submit') }}" class="needs-validation" novalidate>
                                ...
                                <div class="row g-3">
                                    <div class="col-12">
                                        <label for="name" class="form-label d-flex flex-row gap-2 fw-semibold    ls-wide">Naam
                                    ...
                                    <div class="col-md-6">
                                        <label for="email" class="form-label d-flex flex-row gap-2 fw-semibold    ls-wide">E-mail
                                            <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-6">
                                        <label for="phone" class="form-label d-flex flex-row gap-2 fw-semibold    ls-wide">Telefoonnummer</label>
                                        <input id="phone" type="text"
                                               class="form-control p-3   @error('phone') is-invalid @enderror"
                                    ...
                                    <div class="col-12">
                                        <label for="message"
                                               class="form-label d-flex flex-row gap-2 fw-semibold    ls-wide">Bericht <span
                                                class="text-danger">*</span></label>
                                        <textarea id="message" name="message"  rows="6"
                                                  class="form-control p-3   @error('message') is-invalid @enderror"
                                                  placeholder="Waar kunnen we u mee helpen?">{{ old('message') }}</textarea>
                                        @error('message')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-12 mt-4">
                                        <button type="submit" onclick="handleButtonClick(this)"
